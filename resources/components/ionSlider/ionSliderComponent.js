var IonSliderComponent = BaseComponent.extend({
    value: [],
    update : function() {
        var myself = this;
        ...
        $("html head:first").append("<link rel=\"stylesheet\" href=\""+window.location.protocol+"//"+window.location.host+webAppPath+"/api/repos/IvyDC/resources/components/ionSlider/css/"+myself.skins+".css\" id=\"skinCss\" />");
